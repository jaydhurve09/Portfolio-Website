...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='work' className='w-full p-[12%] py-10 scroll-mt-20'>
      ...
      href="https://github.com/jaydhurve09/" className='w-max flex items-center justify-center text-gray-700 gap-2 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:hover:bg-darkHover dark:border-white/50'>
