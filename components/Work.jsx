...
const Work = () => {
  return (
    <div id='#work' className='w-full p-[12%] py-10 scroll-mt-20'>
      <h4 className='text-center mb-2 text-lg font-Ovo'>My Portfolio</h4>
      <h2 className='text-center text-5xl font-Ovo'>My latest Work</h2>
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Neque possimus error ea incidunt! Quibusdam, deleniti? Non quasi odit, omnis quae architecto illo eveniet.</p>
      ...
      <a href="" className='w-max flex items-center justify-center text-gray-700 gap-2 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>
